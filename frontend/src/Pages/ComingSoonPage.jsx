  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#f8f6f2] to-[#f3e9db] px-4 py-12 lg:px-8">
      <div className="flex flex-col items-center w-full">
        ...
        <Link to="/students" className="mt-2 inline-block px-8 py-3 rounded bg-[#294122] text-xl font-semibold text-white hover:bg-emerald-700 transition">Back to Students</Link>
      </div>
    </div>
  );
}
