...
const Hero = ({
  title = 'Daycare AI Activity Suggestions',
      ...
      <div className="mx-auto max-w-2xl py-16 sm:py-24 md:py-32 lg:py-44">
        <div className="text-center">
          ...
          <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-x-6 w-full max-w-xs mx-auto sm:max-w-none">
            <Link to="/add-student" className="rounded-md bg-[#FFEDD2] px-6 py-3 text-base font-semibold text-[#294122] shadow-md hover:bg-[#FFBBA6] hover:text-[#294122] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#FFEDD2] transition w-full sm:w-auto text-center">
              Get Started
            </Link>
            <Link to="/coming-soon" className="text-base font-semibold text-[#FFEDD2] hover:text-[#FFBBA6] transition w-full sm:w-auto text-center">Coming Soon <span aria-hidden="true">→</span></Link>
          </div>
        </div>
      </div>
    </section>
