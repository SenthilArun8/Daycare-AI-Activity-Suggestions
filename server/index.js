...
app.use(cors({
  origin: ['http://localhost:3000', 'https://daycare-ai-activity-suggestio-git-ce06d5-senthilarun8s-projects.vercel.app', 'https://daycare-ai-activity-suggestions-dbr1sl6ia.vercel.app'],
  credentials: true,
